...
//
// Configuration changes should be made in the Basic_Receiver_Logger_Settings file not here !
//
//**************************************************************************************************

#define programname "Basic_Receiver_Logger_061017"
...
#include "Basic_Receiver_Logger_Settings.h"
...
void enter_CalibrationOffset()
{
  ...
  while (Serial.available() > 0)
  {
    temp = Serial.read();                      //clear keyboard buffer
  }
}
...
#ifndef NoMenu
  byte ptr;
  unsigned int returnedCRC, index;
