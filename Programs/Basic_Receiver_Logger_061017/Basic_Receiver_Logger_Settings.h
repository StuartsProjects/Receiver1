...
#define UseSD 
//#define Board_Definition "Sensor1_Board_Definitions.h"   //define the board definition file to use here
...
#define NoMenu                          //having no terminal menu reduces Flash requirement, you cannot have the menu, Bluetooth uplink and SD card logging together
...
const byte lora_TXBUFF_Size = 16;           //logger does not send much 
...
//#define USE_SendOnlySoftwareSerial         //if you want the Bluetooth device on a pin other than the hardware serial por, define this
